...
<head>
    ...
    function deleteIserted() {
        ...
        window.location.href = "<%=request.getContextPath()%>"+"/home_index.action";
    }
...
<section id="content" class="m-t-lg wrapper-md animated fadeInUp">
    <div class="container aside-xxl" style="width: 670px"> <a class="navbar-brand block" href="#" style="font-size: 24px">账号中心</a>
